CREATE TYPE role_child_status AS ENUM ('active', 'inactive');

CREATE TYPE role_child_method AS ENUM (
    'GET',
    'POST',
    'PUT',
    'DELETE',
...
CREATE TABLE
    module_childs (
        ...
        path TEXT NOT NULL,
        method role_child_method NOT NULL,
        name VARCHAR(255),
        is_private BOOLEAN DEFAULT FALSE,
        status role_child_status DEFAULT 'active',
