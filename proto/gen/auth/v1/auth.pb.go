...
const (
	ForgotPasswordType_FORGOT_PASSWORD_TYPE_UNSPECIFIED ForgotPasswordType = 0
	ForgotPasswordType_FORGOT_PASSWORD_TYPE_TOKEN       ForgotPasswordType = 1
)

// Enum value maps for ForgotPasswordType.
var (
	ForgotPasswordType_name = map[int32]string{
		0: "FORGOT_PASSWORD_TYPE_UNSPECIFIED",
		1: "FORGOT_PASSWORD_TYPE_TOKEN",
	}
...
type ForgotPasswordRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Os            string                 `protobuf:"bytes,2,opt,name=os,proto3" json:"os,omitempty"`
	Method        ForgotPasswordType     `protobuf:"varint,3,opt,name=method,proto3,enum=auth.v1.ForgotPasswordType" json:"method,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ForgotPasswordRequest) GetMethod() ForgotPasswordType {
	...
	return ForgotPasswordType_FORGOT_PASSWORD_TYPE_UNSPECIFIED
}
...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xdf\x01\n" +
	"\bUserInfo\x12\x0e\n" +
	...
	"\bbirthday\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\bbirthday\"j\n" +
	"\x11CheckTokenRequest\x12U\n" +
	"\x05token\x18\x01 \x01(\tB?\xbaH<\xba\x019\n" +
	"\x0etoken_required\x12\x16Vui lòng nhập token\x1a\x0fthis.size() > 0R\x05token\"B\n" +
	"\x12CheckTokenResponse\x12\x12\n" +
	"\x04data\x18\x01 \x01(\bR\x04data\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"{\n" +
	"\fLoginRequest\x12-\n" +
	"\x0eemail_or_phone\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\femailOrPhone\x12#\n" +
	"\bpassword\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x06R\bpassword\x12\x17\n" +
	"\x02os\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02os\"\x98\x01\n" +
	"\rLoginResponse\x12%\n" +
	...
	"\tfull_name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18dR\bfullName\x12%\n" +
	"\bpassword\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\bpassword\x124\n" +
	"\x10confirm_password\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\x0fconfirmPassword\x12\x1b\n" +
	"\x04code\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04code\x12\x17\n" +
	"\x02os\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02os\"i\n" +
	"\x10RegisterResponse\x12%\n" +
	"\x04user\x18\x01 \x01(\v2\x11.auth.v1.UserInfoR\x04user\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"\\\n" +
	"\x13RefreshTokenRequest\x12,\n" +
	"\rrefresh_token\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\frefreshToken\x12\x17\n" +
	"\x02os\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02os\"x\n" +
	...
	"\x02os\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x02os\x12=\n" +
	"\x06method\x18\x03 \x01(\x0e2\x1b.auth.v1.ForgotPasswordTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06method\"\x83\x01\n" +
	...
	"\fnew_password\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\vnewPassword\x124\n" +
	"\x10confirm_password\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\x0fconfirmPassword\"7\n" +
	...
	"\fnew_password\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\vnewPassword\x124\n" +
	"\x10confirm_password\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x06\x182R\x0fconfirmPassword\"8\n" +
	"\x1cResetPasswordByTokenResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"N\n" +
	"\x10CheckCodeRequest\x12\x1b\n" +
	"\x04code\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04code\x12\x1d\n" +
	"\x05email\x18\x02 \x01(\tB\a\xbaH\x04r\x02`\x01R\x05email\"C\n" +
	"\x11CheckCodeResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage*Z\n" +
	"\x12ForgotPasswordType\x12$\n" +
	" FORGOT_PASSWORD_TYPE_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aFORGOT_PASSWORD_TYPE_TOKEN\x10\x012\x83\x06\n" +
	"\vAuthService\x12E\n" +
	"\n" +
	"CheckToken\x12\x1a.auth.v1.CheckTokenRequest\x1a\x1b.auth.v1.CheckTokenResponse\x126\n" +
	...
	"\rVerifyAccount\x12\x1d.auth.v1.VerifyAccountRequest\x1a\x1e.auth.v1.VerifyAccountResponse\x12Q\n" +
	"\x0eForgotPassword\x12\x1e.auth.v1.ForgotPasswordRequest\x1a\x1f.auth.v1.ForgotPasswordResponse\x12`\n" +
	"\x13ResetPasswordByCode\x12#.auth.v1.ResetPasswordByCodeRequest\x1a$.auth.v1.ResetPasswordByCodeResponse\x12c\n" +
	"\x14ResetPasswordByToken\x12$.auth.v1.ResetPasswordByTokenRequest\x1a%.auth.v1.ResetPasswordByTokenResponse\x12B\n" +
	"\tCheckCode\x12\x19.auth.v1.CheckCodeRequest\x1a\x1a.auth.v1.CheckCodeResponseB\x0fZ\rauth/v1;protob\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	(ForgotPasswordType)(0),              // 0: auth.v1.ForgotPasswordType
	(*UserInfo)(nil),                     // 1: auth.v1.UserInfo
	(*CheckTokenRequest)(nil),            // 2: auth.v1.CheckTokenRequest
	(*CheckTokenResponse)(nil),           // 3: auth.v1.CheckTokenResponse
	...
	(*VerifyAccountRequest)(nil),         // 12: auth.v1.VerifyAccountRequest
	(*VerifyAccountResponse)(nil),        // 13: auth.v1.VerifyAccountResponse
	(*ForgotPasswordRequest)(nil),        // 14: auth.v1.ForgotPasswordRequest
	(*ForgotPasswordResponse)(nil),       // 15: auth.v1.ForgotPasswordResponse
	(*ResetPasswordByCodeRequest)(nil),   // 16: auth.v1.ResetPasswordByCodeRequest
	(*ResetPasswordByCodeResponse)(nil),  // 17: auth.v1.ResetPasswordByCodeResponse
	(*ResetPasswordByTokenRequest)(nil),  // 18: auth.v1.ResetPasswordByTokenRequest
	(*ResetPasswordByTokenResponse)(nil), // 19: auth.v1.ResetPasswordByTokenResponse
	(*CheckCodeRequest)(nil),             // 20: auth.v1.CheckCodeRequest
	(*CheckCodeResponse)(nil),            // 21: auth.v1.CheckCodeResponse
	(*timestamppb.Timestamp)(nil),        // 22: google.protobuf.Timestamp
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	22, // 0: auth.v1.UserInfo.birthday:type_name -> google.protobuf.Timestamp
	1,  // 1: auth.v1.LoginResponse.user:type_name -> auth.v1.UserInfo
	1,  // 2: auth.v1.RegisterResponse.user:type_name -> auth.v1.UserInfo
	0,  // 3: auth.v1.ForgotPasswordRequest.method:type_name -> auth.v1.ForgotPasswordType
	1,  // 4: auth.v1.ForgotPasswordResponse.user:type_name -> auth.v1.UserInfo
	2,  // 5: auth.v1.AuthService.CheckToken:input_type -> auth.v1.CheckTokenRequest
	...
	12, // 10: auth.v1.AuthService.VerifyAccount:input_type -> auth.v1.VerifyAccountRequest
	14, // 11: auth.v1.AuthService.ForgotPassword:input_type -> auth.v1.ForgotPasswordRequest
	16, // 12: auth.v1.AuthService.ResetPasswordByCode:input_type -> auth.v1.ResetPasswordByCodeRequest
	18, // 13: auth.v1.AuthService.ResetPasswordByToken:input_type -> auth.v1.ResetPasswordByTokenRequest
	20, // 14: auth.v1.AuthService.CheckCode:input_type -> auth.v1.CheckCodeRequest
	3,  // 15: auth.v1.AuthService.CheckToken:output_type -> auth.v1.CheckTokenResponse
	5,  // 16: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	7,  // 17: auth.v1.AuthService.Register:output_type -> auth.v1.RegisterResponse
	...
	13, // 20: auth.v1.AuthService.VerifyAccount:output_type -> auth.v1.VerifyAccountResponse
	15, // 21: auth.v1.AuthService.ForgotPassword:output_type -> auth.v1.ForgotPasswordResponse
	17, // 22: auth.v1.AuthService.ResetPasswordByCode:output_type -> auth.v1.ResetPasswordByCodeResponse
	19, // 23: auth.v1.AuthService.ResetPasswordByToken:output_type -> auth.v1.ResetPasswordByTokenResponse
	21, // 24: auth.v1.AuthService.CheckCode:output_type -> auth.v1.CheckCodeResponse
